...
const atividade = {
  nome: 'Almoço',
  data: new Date('2024-07-08 10:00'), //a função Date tem que sempre ser usada nesse formato: (AAAA-MM-DD)
  finalizada: true
}
...
const atualizarListaDeAtividades = () => {
  ...
  //Estrutura de repetição precisa de uma lista, neste caso, a lista é "atividades"
...
const salvarAtividade = event => {
  //preventDefault significa: não faça o padrão!
...
const criarHorasSelecao = () => {
  ...
  //estrutura de laço ou repetição, e atribuição de valor a variável (i)
  for (let i = 6; i < 23; i++) {
...
const concluirAtividade = event => {
  ...
  atividades.finalizada = !atividade.finalizada
}
